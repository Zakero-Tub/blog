...
export class ArticleDeleteDialog extends React.Component<IArticleDeleteDialogProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="blogApp.article.delete.question">Are you sure you want to delete this Article?</ModalBody>
        <ModalFooter>
          <Button color="secondary" onClick={this.handleClose}>
            <FontAwesomeIcon icon="ban" />
            &nbsp; Cancel
          </Button>
          <Button id="jhi-confirm-delete-article" color="danger" onClick={this.confirmDelete}>
